...
/// </remarks>
public class SmoothSyncExamplePlayerControllerPUN : PunBehaviour
{
    Rigidbody rb;
    Rigidbody2D rb2D;
    SmoothSyncPUN smoothSync;
    SmoothSyncPUN childSmoothSync;
	...
	void Start()
    {
        ...
        smoothSync = GetComponent<SmoothSyncPUN>();
        childSmoothSync = childObjectToControl.GetComponent<SmoothSyncPUN>();
	...
	void Update()
    {
        ...
        {
            smoothSync.teleportAnyObject(transform.position + Vector3.right * 18, transform.rotation, transform.localScale);
            childSmoothSync.teleportAnyObject(childSmoothSync.getPosition(), childSmoothSync.getRotation(), childSmoothSync.getScale());
        }
    ...
    /// </remarks>
    /// </summary>
    public static bool validateStateOfPlayer(StatePUN latestReceivedState, StatePUN latestValidatedState)
    {
